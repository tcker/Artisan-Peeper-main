...
const Assessmentchoices = () => {
  ...
  return (
    ...
    <div className='flex flex-col justify-center items-center '>
      <h1 className='ml-24 mr-1 mt-7  px-4 max-w-auto text-center text-[2rem] border-b-[2px] mb-5 rounded-md  border-black dark:border-slate-400 text-wrap '>Soft Skills Evaluation</h1>
