...
const AboutCard = ({image, name, job, email, contact}) => {
  return (
    <div className='block h-64 w-96 p-5 dark:bg-slate-900 shadow-md rounded-xl border-[1px]'
    >
    <div className='flex justify-center items-center pb-4 border-b-[1px] border-black'>
      <img className='h-28 rounded-full mr-5 border-2 bg-black dark:bg-indigo-500' src={image} alt='Profile'/>
      <div>
